...
var eurecaClientSetup = function() {
	...
	eurecaClient.exports.spawnEnemy = function(i, x, y)
	{
		...
		console.log('NEW PLAYER JOINED THE MASACRE');
...
Tank.prototype.damage = function(){
	console.log(this.tank.id + " IS GETTING POUNDED!");
	this.health--;
    ...
    for (var i in tanksList)
    {
		...
		for (var j in tanksList)
		{
			...
			if (j!=i) 
			{
				...
				game.physics.arcade.collide(tank, tanksList[i].tank);
...
function bulletHitPlayer (tank, bullet) {
	...
	tanksList[tank.id].damage();

	console.log(tank.id, 'THE TANK')

	//for(var i in tanksList){
	//	if(tanksList[i].id !== myId){
	//		console.log(tanksList[i].player ? tanksList[i].player.id : "NO ID")
	//		console.log(tanksList[i].player);
	//		tanksList[i].damage();
    //
	//		//console.log(i);
	//	}
